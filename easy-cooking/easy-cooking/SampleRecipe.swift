...
class SampleRecipe {
    ...
    struct SearchResult {
        ...
        var resultAmout: String
        var resultRecipeId: String
        
        init(recipe: Recipe, amount: Int){
            resultTitle = recipe.title
            resultAmout = amount.description + "円"
    ...
    init(){
        ...
        targetRecipe = Recipe(redipeId: "RC0110_002", title: "牛肉とキャベツのオイスターソース炒め", amount: 220, peaple: 1, foodList: foodWithAmounts, recipeDescription:"①牛肉は、塩と胡椒で下味する。キャベツは、ざく切りにする。\n②フライパンに油を引いて、牛肉を入れて炒める。色が変わったらキャベツも入れて炒める。\n③砂糖、醤油、オイスターソースを混ぜる。")
        
        sampleRecipes.append(targetRecipe)
        sampleSearchResults.append(SearchResult(recipe: targetRecipe, amount: targetRecipe.amount/targetRecipe.peaple))
        ...
        targetRecipe = Recipe(redipeId: "RC0112_001", title: "トマトと牛肉のガーリック炒め", amount: 480, peaple: 2, foodList: foodWithAmounts, recipeDescription: "①トマトは8等分にする。牛肉は食べやすい大きさに切る。\n②バター、おろしにんにく、酒、砂糖、醤油を合わせる。\n③フライパンにサラダ油を中火で熱し、牛肉を炒める。色が変わったら塩、こしょうをふり、トマトを加えてサッと炒める。\n④②を加えて全体的にからめる。")
